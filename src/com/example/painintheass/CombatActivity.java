...
public class CombatActivity extends Activity {
	...
	private void initGUI(int width, int height, CombatUIManager myUIM){
		...
		Widget[] state = {menu,archer,knight,mage,spell,miner,money,coin};
		...
		Widget[] state2 = {menu,archer,knight,mage,spell,map,options,quit,miner,money,coin};
		...
		Widget[] state3 = {menu,archer,knight,mage,spell,fire,meteor,stars,miner,money,coin};
		...
		Widget[] state4 = {menu,archer,knight,mage,spell,confirmWindow,ok,cancel,miner,money,coin};
		...
		Widget[] state5 = {menu,archer,knight,mage,spell,confirmWindow,ok2,cancel,miner,money,coin};
